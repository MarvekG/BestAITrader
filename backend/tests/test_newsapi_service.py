...
async def test_search_returns_normalized_results(monkeypatch):
    monkeypatch.setattr("app.ai.agentic.tooling.news_plugins.newsapi.settings.NEWS_API_KEY", "test-key")
...
async def test_search_returns_empty_when_api_key_missing(monkeypatch):
    monkeypatch.setattr("app.ai.agentic.tooling.news_plugins.newsapi.settings.NEWS_API_KEY", "")
