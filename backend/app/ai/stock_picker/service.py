        ...
        messages: List[Any] = [
            SystemMessage(
                content=(
                    ...
                    "在引用工具返回的数据前，必须先调用 `get_current_time` 获取当前系统时间以判断数据的时效性和有效性。"
                    ...
                    "Before using any data from tools, call `get_current_time` to get the current system time and assess data freshness and validity."
