...
RESEARCH_AGENT_SYSTEM_PROMPTS = {
    "zh": (
        ...
        "并说明疑问是什么、为什么需要用户确认。\n"
        "9. 必须校验证据时效性；如果行情、财务、资金流、新闻或公告数据不够新，先调用可用工具拉取/刷新数据，"
    ...
    "en": (
        ...
        "9. Validate evidence freshness. If market, financial, capital-flow, news, or announcement data is not fresh enough, "
