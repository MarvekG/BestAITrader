...
class Settings(BaseSettings):
    ...
    SANDBOX_EXECUTION_MODE: str = Field(default="pooled_worker", pattern="^(pooled_worker|one_shot_worker)$")
    ...
    SANDBOX_MAX_CONCURRENT_EXECUTIONS: int = Field(default=2, ge=1)
