...
> 项目不附带任何第三方行情、新闻、搜索或金融数据授权；启用相关数据源前，请自行确认服务条款、缓存限制和再分发限制。
...
天枢智投的源码开放许可定位，也不代表项目之间存在官方从属或授权关系。
...
本项目采用 [MIT License](./LICENSE)，允许商业和非商业用途，包括使用、复制、修改、合并、出版发行、散布、再许可和/或销售本软件的副本。
